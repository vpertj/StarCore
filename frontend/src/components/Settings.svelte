<script>
 ...
 import { editorSettings, updateEditorSetting } from '../stores/editorSettings.js'
  ...
  import { GetSkills, SaveSkill, DeleteSkill, InstallSkillFromURL } from '../../wailsjs/go/main/App.js'
 ...
 async function loadSkills() {
    try {
      ...
      skills.set(list || [])
    } catch (/** @type {any} */ e) { console.error('Load skills failed:', e) }
  }
...
function setTab(tabId) {
  activeTab = tabId; if (tabId === 'skills') loadSkills();
}
...
{#if $settingsVisible}
  <div class="dialog-backdrop" transition:fade={{ duration: 150 }} onclick={(e) => { if (e.target === e.currentTarget) settingsVisible.set(false); }} role="button" tabindex="-1" onkeydown={(e) => { if (e.key === 'Escape') settingsVisible.set(false) }}>
        ...
        <div class="flex-1 overflow-y-auto p-6">
          ...
          {:else if activeTab === 'appearance'}
            <div class="space-y-6">
              ...
              <div>
                <label for="settings-ui-fontfamily" class="block text-sm font-medium mb-2" style="color: var(--text-primary);">{$t('settings.appearance.fontFamily')}</label>
                <select
          ...
          {:else if activeTab === 'editor'}
            ...
            <div class="space-y-6">
              <div>
                <label for="settings-editor-fontsize" class="block text-sm font-medium mb-2" style="color: var(--text-primary);">{$t('settings.editor.fontSize')}</label>
                <div class="flex items-center gap-3">
                  <input type="range" value={$editorSettings.fontSize} min="11" max="28" class="flex-1" oninput={(e) => updateEditorSetting('fontSize', parseInt(/** @type {HTMLInputElement} */ (e.target).value))} />
                  <span class="text-sm font-mono" style="color: var(--text-primary); min-width: 28px;">{$editorSettings.fontSize}px</span>
                </div>
              </div>
              <div>
                <label for="settings-editor-fontfamily" class="block text-sm font-medium mb-2" style="color: var(--text-primary);">{$t('settings.editor.fontFamily')}</label>
                <select id="settings-editor-fontfamily" value={$editorSettings.fontFamily} class="w-full px-3 py-2 rounded border text-sm" style="background-color: var(--bg-primary); color: var(--text-primary); border-color: var(--border);" onchange={(e) => updateEditorSetting('fontFamily', /** @type {HTMLSelectElement} */ (e.target).value)}>
              ...
              <div>
                ...
                <select value={$editorSettings.highlightTheme} class="w-full px-3 py-2 rounded border text-sm" style="background-color: var(--bg-primary); color: var(--text-primary); border-color: var(--border);" onchange={(e) => updateEditorSetting('highlightTheme', /** @type {HTMLSelectElement} */ (e.target).value)}>
              ...
              <div>
                ...
                <div class="flex items-center gap-3">
                  <input type="range" value={$editorSettings.lineHeight} min="1.2" max="2.4" step="0.1" class="flex-1" oninput={(e) => updateEditorSetting('lineHeight', parseFloat(/** @type {HTMLInputElement} */ (e.target).value))} />
              ...
              <div>
                ...
                <div class="flex items-center gap-2">
                  <input type="checkbox" checked={$editorSettings.wordWrap} class="rounded" onchange={(e) => updateEditorSetting('wordWrap', /** @type {HTMLInputElement} */ (e.target).checked)} />
                ...
                <div class="space-y-4">
                  <div class="flex gap-4">
                    <div class="flex-1">
                      ...
                      <div class="flex items-center gap-2">
                        <input type="range" value={$editorSettings.cursorWidth} min="1" max="6" class="flex-1" oninput={(e) => updateEditorSetting('cursorWidth', parseInt(/** @type {HTMLInputElement} */ (e.target).value))} />
                    ...
                    <div class="flex-1">
                      ...
                      <div class="flex items-center gap-2">
                        <input type="color" value={$editorSettings.cursorColor} class="w-8 h-8 rounded border cursor-pointer" style="border-color: var(--border);" oninput={(e) => updateEditorSetting('cursorColor', /** @type {HTMLInputElement} */ (e.target).value)} />
                  ...
                  <div class="flex gap-4">
                    <div class="flex-1">
                      ...
                      <div class="flex items-center gap-2">
                        <input type="range" value={$editorSettings.cursorHeight} min="20" max="100" step="5" class="flex-1" oninput={(e) => updateEditorSetting('cursorHeight', parseInt(/** @type {HTMLInputElement} */ (e.target).value))} />
                    ...
                    <div class="flex-1">
                      ...
                      <select value={$editorSettings.cursorStyle} class="w-full px-2 py-1.5 rounded border text-xs" style="background-color: var(--bg-primary); color: var(--text-primary); border-color: var(--border);" onchange={(e) => updateEditorSetting('cursorStyle', /** @type {HTMLSelectElement} */ (e.target).value)}>
                    ...
                    <div class="flex-1">
                      ...
                      <select value={$editorSettings.cursorBlinkStyle} class="w-full px-2 py-1.5 rounded border text-xs" style="background-color: var(--bg-primary); color: var(--text-primary); border-color: var(--border);" onchange={(e) => updateEditorSetting('cursorBlinkStyle', /** @type {HTMLSelectElement} */ (e.target).value)}>
          ...
          {:else if activeTab === 'skills'}
            ...
            {#if showCreateSkillDialog}
              <div class="fixed inset-0 z-[60] flex items-center justify-center" style="background-color: rgba(0,0,0,0.5);" onclick={(e) => { if (e.target === e.currentTarget) showCreateSkillDialog = false }} role="button" tabindex="-1" onkeydown={(e) => { if (e.key === 'Escape') showCreateSkillDialog = false }}>
            ...
            {#if showImportSkillDialog}
              <div class="fixed inset-0 z-[60] flex items-center justify-center" style="background-color: rgba(0,0,0,0.5);" onclick={(e) => { if (e.target === e.currentTarget) showImportSkillDialog = false }} role="button" tabindex="-1" onkeydown={(e) => { if (e.key === 'Escape') showImportSkillDialog = false }}>
