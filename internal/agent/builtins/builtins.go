	...
	return []agent.AgentDef{
		{
			...
			SystemPrompt: `You are a versatile programming assistant proficient in multiple languages and frameworks. Help with coding, debugging, explaining concepts, and optimizing performance. Reply in the user's language. Be concise and precise.`,
			DefaultModel: "",  // auto: provider's best available
			Tools:  []string{"read_file", "write_file", "edit_file", "search_files", "list_directory", "glob_files", "execute_command", "http_request", "web_fetch", "get_git_diff", "git_commit", "git_pull", "git_push", "skill", "sub_agent"},
		...
		},
		{
			...
			DefaultModel: "",  // auto: provider's best available
			Tools:  []string{"read_file", "write_file", "edit_file", "search_files", "list_directory", "glob_files", "get_git_diff", "git_commit", "git_pull", "git_push", "skill", "sub_agent"},
		...
		},
		{
			...
			DefaultModel: "",  // auto: provider's best available
			Tools:  []string{"read_file", "write_file", "edit_file", "search_files", "glob_files", "execute_command", "http_request", "web_fetch", "get_git_diff", "git_commit", "git_pull", "git_push", "skill", "sub_agent"},
		...
		},
		{
			...
			DefaultModel: "",  // auto: provider's best available
			Tools:  []string{"read_file", "write_file", "edit_file", "search_files", "glob_files", "skill", "sub_agent"},
		...
		},
		{
			...
			DefaultModel: "",  // auto: provider's best available
			Tools:  []string{"read_file", "write_file", "edit_file", "execute_command", "skill", "sub_agent"},
			Skills: []string{"generate-doc"},
		},
		{
		...
		},
		{
			...
			DefaultModel: "",  // auto: provider's best available
			Tools:  []string{"read_file", "search_files", "glob_files", "skill", "sub_agent"},
